...
func TestLinearSequential_Forward(t *testing.T) {
	...
	output := linearSequential.Forward(&input)
...
func BenchmarkLinearSequential(b *testing.B) {
	...
	b.ResetTimer()
	for range b.N {
		linearSequential.Forward(&input)
	}
}
